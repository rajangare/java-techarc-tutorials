...
public class HazelcastPagingExample {
    public static void main(String[] args) {
        ...
        //Create Paging predicate with page size 20
        PagingPredicate<Integer, User> pagingPredicate = Predicates.pagingPredicate(equalPredicate, descendingComparator, 8);
