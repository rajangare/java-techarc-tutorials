...
public class SerializableExampleFailing {
    public static void main(String... args) {
        ...
        Employee employee = new Employee(123,"JavaTechARC 3i", "javatecharc3i@gmail.com", "123456789");

        // add employee to map
        System.out.println("Serializing key-value and add to map");
        employeeOwners.put(employee, "test demo");
        Employee employee1 = new Employee(123,"JavaTechARC 3i", "javatecharc3i@gmail.com", "987654321");
        ...
        Employee employee2 = new Employee(123,"JavaTechARC 3i", "javatecharc3i@gmail.com", "123456789");
        System.out.println("Checking if employee with JavaTechARC 3i is present");
